...
function ff_dich_chuyen()	
	...
	Talk(1, "", "Chóc mõng "..myplayersex().." ®· nhËn ®­îc <color=green>Phi Phong 10 - DÞch ChuyÓn Tøc Thêi"); 		
end
function ff_sat_thuong()	
	tbAwardTemplet:GiveAwardByList(tb_ff_sat_thuong, "Mo tui phi phong");
	ConsumeEquiproomItem(1,6,1,30469,-1)--xoa Item ff
	Talk(1, "", "Chóc mõng "..myplayersex().." ®· nhËn ®­îc <color=green>Phi Phong 10 - Hãa Gi¶i S¸t Th­¬ng"); 		
end

function ff_trong_kich()	
	tbAwardTemplet:GiveAwardByList(tb_ff_trong_kich, "Mo tui phi phong");
	ConsumeEquiproomItem(1,6,1,30469,-1)--xoa Item ff
	Talk(1, "", "Chóc mõng "..myplayersex().." ®· nhËn ®­îc <color=green>Phi Phong 10 - Träng KÝch"); 		
end
