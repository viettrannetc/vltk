...
local _GetFruit = function(nItemIndex,P)
	if ConsumeItem(3, 1, 6, 1, 30226, -1) ~= 1 then
	...
	local tbTranslog = {strFolder ="ruonghoangkim/", nPromID = 22, nResult = 1}
...
function main(nItemIndex)
	...
	if P >= 4825 and P <= 4834 then
		local nCount = CalcItemCount(3, 6, 1, 30226, -1)
		if nCount >= 1 then
