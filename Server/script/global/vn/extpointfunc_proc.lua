...
function OnPayYuanBao(nChangeValue)
	...
	--ÄÃÒøÔª±¦
		...
		WriteLog(date("%Y%m%d %H%M%S").."\t".."Rót TiÒn §ång"..GetAccount().."\t"..GetName().."\t".."Rót "..COIN.." TiÒn §ång cßn l¹i "..nCurValue*20)
 		Say("¤ng chñ tiÒn trang: §©y lµ "..COIN.." TiÒn §ång cña kh¸ch quan! Xin nhËn lÊy!", 0)
		Msg2Player( "B¹n nhËn ®­îc "..COIN.." TiÒn §ång !");
