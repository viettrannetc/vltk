...
MSG_COMPOSE_TITLE = "Hîp thµnh 1 trang bÞ Tinh S­¬ng yªu cÇu cã 1111 Tö Tinh Kho¸ng Th¹ch, 1 Tinh S­¬ng Th¹ch, Ýt cÇn cã 1 §å Phæ Tinh S­¬ng t­¬ng øng vµ trang bÞ §»ng Long, 20000 v¹n l­îng, vµ c¸c nguyªn liÖu kh¸c lµm t¨ng tØ lÖ thµnh c«ng"
...
AdditiveMaterial =
{	
	{szName = "HuyÒn ThiÕt", tbProp = {6,1,4846}, nSuccessRate = 5, nMaxSuccessRate = 45},
}
...
tbFormulaList = 
{
	[1] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Tinh S­¬ng H¹ng Liªn", tbProp = {6,1,4841}, nSuccessRate = 10, nMaxSuccessRate = 80},
		},				
		nWidth = 2,
		nHeight = 1,
	...
	{				
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Tinh S­¬ng Kh«i", tbProp = {6,1,4836}, nSuccessRate = 10, nMaxSuccessRate = 80},			
		},
		nWidth = 2,
		nHeight = 2,
		nFreeItemCellLimit = 1,		
	...
	[3] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Tinh S­¬ng Th­îng Giíi", tbProp = {6,1,4843}, nSuccessRate = 10, nMaxSuccessRate = 80},			
		},		
		nWidth = 1,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[4] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Tinh S­¬ng Hé UyÓn", tbProp = {6,1,4840}, nSuccessRate = 10, nMaxSuccessRate = 80},			
		},		
	...
	[5] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Tinh S­¬ng Yªu §¸i", tbProp = {6,1,4839}, nSuccessRate = 10, nMaxSuccessRate = 80},			
		},
		nWidth = 2,
		nHeight = 1,
		nFreeItemCellLimit = 1,
	...
	[6] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Tinh S­¬ng Y", tbProp = {6,1,4837}, nSuccessRate = 10, nMaxSuccessRate = 80},			
		},		
		nWidth = 2,
		nHeight = 3,
		nFreeItemCellLimit = 1,
	...
	[7] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Tinh S­¬ng Vò KhÝ", tbProp = {6,1,4845}, nSuccessRate = 10, nMaxSuccessRate = 80},			
		},		
	...
	[8] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Tinh S­¬ng Hµi", tbProp = {6,1,4838}, nSuccessRate = 10, nMaxSuccessRate = 80},			
		},			
	...
	[9] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "§å Phæ Tinh S­¬ng Béi", tbProp = {6,1,4842}, nSuccessRate = 10, nMaxSuccessRate = 80},			
		},				
	...
	[10] = 
	{
		...
		tbSpecialMaterial = 
		{
			{szName = "Tinh S­¬ng §å Phæ H¹ Giíi", tbProp = {6,1,4844}, nSuccessRate = 10, nMaxSuccessRate = 80},		
		},		
...
function tbItem2BaiHu:ComposeGiveUI()
	...
	szContent = format("%s<enter>%-20s  %s", szContent, "1 Trang BÞ §»ng Long t­¬ng øng", "1")
	szContent = format("%s<enter>%-20s  %s", szContent, "§å Phæ Tinh S­¬ng", "1")
...
--T¹m ®ãng tÝnh n¨ng chÕ t¹o Tinh S­¬ng - Modified By DinhHQ - 20120511
pEventType:Reg("Thî rÌn trong thµnh", "ChÕ T¹o Trang BÞ Tinh S­¬ng", tbItem2BaiHu.SelectParts, {tbItem2BaiHu})
