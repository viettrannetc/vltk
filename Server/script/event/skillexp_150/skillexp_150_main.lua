...
NADD_SKILLEXP_PER = 1000		-- Ã¿´Î¶Ò»»¿ÉÒÔ»ñµÃµÄÊìÁ·¶È
...
local tbShibeiNpc = {
	...
	{nNpcId = 1623, szName = "Cöu KiÕm Hîp NhÊt Bia", tbNpcParam = {1369},},
	{nNpcId = 1623, szName = "ThÇn Quang Toµn NhiÔu Bia", tbNpcParam = {1384},},
	}	
