...
function main()
	if CalcFreeItemCellCount() < 6 then
			...
			if nGoldPoint > 1000 then 
				Talk(1, "", "Max 1.000 Phong Ph∏o Ti”u ß∆c Bi÷t, Xin h∑y Æi Reset Event Æ” nhÀn th≠Îng ti’p ")				
					return 1;
				end			
	PickUp_haohangx_2()
	AddExtPoint(4,1)
...
tb_Mareial_haohang_khoa = 
{
	100000,
	{
						{G=6,D=1,P=2527,LV=1,nExpiredTime=43200,szname="HÂi Thi™n T∏i Tπo L‘ Bao ",nrate=0.00035}, 
						{G=6,D=1,P=4822,LV=1,szname="Tˆ Tinh Kho∏ng Thπch",nrate=0.070},
						--{G=6,D=1,P=2125,LV=1,szname="NgÚ Hµnh K˙ Thπch",nrate=0.0098},  
