...
function main()
	if CalcFreeItemCellCount() < 6 then
			...
			if nGoldPoint > 600 then 
				Talk(1, "", "Max 600 Phong Ph∏o ßπi ß∆c Bi÷t, Xin h∑y Æi Reset Event Æ” nhÀn th≠Îng ti’p ")				
					return 1;
				end			
	PickUp_haohangx_2()
	AddExtPoint(3,1)
...
tb_Mareial_haohang_khoa = 
{
	100000,
	{
						...
						{G=0,D=11,P=647,LV=1,nExpiredTime=43200,szname="M∆t nπ chi’n tr≠Íng V≠¨ng Gi∂",nrate=0.0018},
						{G=0,D=11,P=806,LV=1,nExpiredTime=43200,szname="M∆t nπ chi’n tr≠Íng Th∏nh Gi∂",nrate=0.0012},
						{G=0,D=11,P=828,LV=1,nExpiredTime=43200,szname="M∆t nπ chi’n tr≠Íng B∏ Gi∂",nrate=0.0010},
						{G=0,D=11,P=817,LV=1,nExpiredTime=43200,szname="M∆t nπ chi’n tr≠Íng Hoµng Gi∂",nrate=0.0001},
						...
						{G=6,D=1,P=30474,LV=10,szname="Minh Ph≠Óng Chi B∂o",nrate=0.0003	},	
