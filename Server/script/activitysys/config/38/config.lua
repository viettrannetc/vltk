...
tbConfig[3] = --Ò»¸öÏ¸½Ú
{
	...
	tbCondition = 
	{
		{"ThisActivity:CheckTask",	{TSK_USED_NEWYEAR_FIREWORKS,MAX_USED_NEWYEAR_FIREWORKS,"Ng­¬i ®· nhËn ®­îc qu?nhiÒu phÇn th­ëng, xin h·y th?c¸i kh¸c ®i!","<"} },
