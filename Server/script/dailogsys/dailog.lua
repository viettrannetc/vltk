...
function DailogClass:_init(szNpcName)
	...
	self.tbOptionList = {}
	self.szTitleMsg = "<npc>Chµo mõng b¹n ®Õn víi <color=yellow>Vâ L©m TruyÒn Kú Offline<color=yellow><enter>- <color=Red>www.youtube.com/c/pgaminggameoffline <color><enter>- Edit tæng hîp By <color=Green>PGaming<color>"
