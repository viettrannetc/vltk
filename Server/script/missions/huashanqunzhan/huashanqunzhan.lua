...
function huashanqunzhan:Judge(tbPlayer)
	...
	Msg2SubWorld(format("Ng­êi Pro NhÊt <color=green>%s<color=yellow> H«m Nay §· h¹ Cháng §İt TÊt C¶ §èi Thñ §ã Chİnh Lµ : <color=pink>%s<color>.", self.szMatchName, szWinerName))
