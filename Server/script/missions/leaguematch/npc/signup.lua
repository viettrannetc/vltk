...
function wlls_want2transback()
	...
	SubWorld = n_oldidx
	if (n_camp) then
		Say("<color=green>ThÞ vÖ héi tr­êng:<color> ChiÕn ®éi cña b¹n kh«ng ph¶i ®ang thi ®Êu sao? NÕu b©y giê rêi ®éi sÏ kh«ng thÓ l·nh phÇn th­ëng. B¹n nghÜ kü ch­a?",
...
function wlls_ready2join()
	...
	if (str) then
		Say("<color=green>Quan viªn héi tr­êng:<color> "..str, 2, "Ta muèn rêi khái héi tr­êng!/wlls_want2transback", "Kh«ng cÇn!/OnCancel")
		return nil
	end
