...
function wlls_leveupcheck()
	...
	if (n_level == 1) then	--ĞÂĞãÕ½¶Ó³ÉÔ±£¬ÅĞ¶ÏÊÇ·ñÔ½¼¶
		if (GetLevel() >= WLLS_LEVEL_SENIOR) then	--ÒÑ¾­Ô½¼¶
			...
			Msg2Player("§¼ng cÊp hiÖn giê cña b¹n ®· v­ît qu¸ yªu cÇu tham gia <color=yellow>Vâ l©m kiÖt xuÊt<color> nh­ng b¹n vÉn cã thÓ tham gia <color=yellow>Vâ l©m kiÖt xuÊt<color> lÇn nµy. Quı sau b¹n sÏ kh«ng thÓ tham gia <color=yellow>§¹i héi vâ l©m<color>.")
			return
		end
	end
