...
function want_playboat()
	...
	if (GetTeamSize() < 2) then
		Say(" Xin lçi! §éi thi ®Êu tham gia ho¹t ®éng ®ua thuyÒn rång cÇn İt nhÊt <color=red>2<color> ng­êi. HiÖn ®éi cña b¹n kh«ng ®ñ ng­êi! H·y ®i t×m thªm b»ng h÷u nhĞ!",0)
		return
	end
	if (GetLevel() >= 90) then
		blevel = 1
