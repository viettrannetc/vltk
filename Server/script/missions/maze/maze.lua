...
function Maze:FinalAward(room)
	...
	for i = 1, getn(players) do
		...
		-- PhÇn th­ëng khi hoµn thµnh v­ît ¶i KiÕm Gia - by AloneScript
		tbAwardTemplet:GiveAwardByList({szName="Hµnh HiÖp LÖnh", tbProp={6,1,2566,1,0,0}, nCount=100}, "PhÇn th­ëng hoµn thµnh v­ît ¶i KiÕm Gia")
	end
end
