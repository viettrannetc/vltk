...
--*****************Lib Dev  thªm tham gia c«ng thµnh************
...
function GiveTiaoZhanLing()
	...
	--**Ìá½»ÌôÕ½Áî
	GiveItemUI("Giao nép khiªu chiÕn lÖnh", "Khiªu chiÕn lÖnh cã thÓ ®æi 50.000 ®iÓm kinh nghiÖm, dïng ®Ó b¸o danh c«ng thµnh chiÕn cho bang héi.", "sure_GiveTiaoZhanLing", "OnCancel");
end
...
--	elseif (TONG_GetExpLevel(nTongID) < 1) then
--		Say("§ßi hái ®¼ng cÊp bang héi ®¹t cÊp 1 trë lªn míi cã thÓ b¸o danh c«ng thµnh chiÕn cho ngµy h«m sau.", 0);
