...
{
	[1] = 8e6,
	[2]={szName="LÖnh Bµi Cöu Ch©u",tbProp={6,1,4667,1,0,0},nCount=1},
	[3]={szName="TiÒn §ång",tbProp={4,417,1,1,0,0,0},nCount=1,nBindState = -2},
}
LastManAward = 
{
	[1]={szName="TiÒn §ång",tbProp={4,417,1,1,0,0,0},nCount=1,nBindState = -2},
	[2]={szName="LÖnh Bµi Cöu Ch©u",tbProp={6,1,4667,1,0,0},nCount=1},
...
--	[12]={szName="Qu¶ Hoµng Kim",tbProp={6,1,907,1,0,0},nCount=1,nRate=19, nExpiredTime = 10080},
	[3]={nExp_tl=1,nRate = 65,nCount = 10000000,},	
}
...
{
	{
		{nExp_tl = 10e6},
		{
			{szName="TiÒn §ång",tbProp={4,417,1,1,0,0,0},nBindState = -2,nCount=10}
--			{szName="Vâ L©m MËt TÞch",tbProp={6,1,2219,1,0,0},nExpiredTime = 43200,nCount=1}
		}
	},
--	{nExp_tl = 28e6},
--	{nExp_tl = 24e6},
