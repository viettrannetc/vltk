...
--		{30,1,{6,1,1606,1,0,0},1,"Viªm §Õ §å §»ng",1}			--ËéÆ¬
	...
	[4]=--×îÖÕboss
	{			
		[1]={{szName="Socola Lo¹i 5",tbProp={6,1,3524,1,0,0},nCount=20,nExpiredTime = 1440,nRate=13.5},},
		[2]={{szName="L­ìi LiÒm B¹c",tbProp={6,1,3198,1,0,0},nCount=20,nRate=13.5},},
		[3]={{szName="Hép B¸nh Trung Thu",tbProp={6,1,4861,1,0,0},nCount=40,nExpiredTime = 1440,nRate=0.5},},
			},
}
