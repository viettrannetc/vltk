...
function main()
	...
	local szFailMsg = format("Mçi ngµy mçi nh©n vËt chØ cã thÓ sö dông nhiÒu nhÊt   %d socola lo¹i 2, ®îi ngµy mai h·y sö dông tiÕp",NDAILYTIME)	
...
tb_Mareial_haohang_khoa = 
{
	100000,
	{
						...
						{G=6,D=1,P=3528,LV=10,nExpiredTime=43200,szname="Socola Lo¹i 1"	 ,nrate=0.005	},
