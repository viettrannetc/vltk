...
--	TB_QIANQIU_YINGLIE0904:reset_task()
	...
	local tb_award = {
		{szName = "Khiªu chiÕn LÔ bao", tbProp = {6,1,2006,1,1,0}, nRate = 30},
...
--		{szName = "Lôc Thñy Tinh", tbProp = {4,240,1,1,1,0}, nRate = 10},
		{szName = "Qu¶ Hoµng Kim", tbProp = {6,1,907,1,0,0}, nRate = 10},
		{szName = "Thiªn V­¬ng Hoµng Kim Trang BÞ B¶o R­¬ng", tbProp = {6,1,907,1,0,0}, nRate = 2},
		{szName = "Ngò §éc Hoµng Kim Trang BÞ B¶o R­¬ng", tbProp = {6,1,4640,1,0,0}, nRate = 2},
		{szName = "Thóy Yªn Hoµng Kim Trang BÞ B¶o R­¬ng", tbProp = {6,1,4641,1,0,0}, nRate = 2},
		{szName = "C«n L«n Hoµng Kim Trang BÞ B¶o R­¬ng", tbProp = {6,1,4642,1,0,0}, nRate = 2},
		{szName = "Thiªn NhÉn Hoµng Kim Trang BÞ B¶o R­¬ng", tbProp = {6,1,4643,1,0,0}, nRate = 2},
		{szName = "ThiÕu L©m Hoµng Kim Trang BÞ B¶o R­¬ng", tbProp = {6,1,4644,1,0,0}, nRate = 2},
		{szName = "§­êng M«n Hoµng Kim Trang BÞ B¶o R­¬ng", tbProp = {6,1,4645,1,0,0}, nRate = 2},
		{szName = "Nga Mi Hoµng Kim Trang BÞ B¶o R­¬ng", tbProp = {6,1,4645,1,0,0}, nRate = 2},
		{szName = "Vâ §ang Hoµng Kim Trang BÞ B¶o R­¬ng", tbProp = {6,1,4646,1,0,0}, nRate = 2},
		{szName = "C¸i Bang Hoµng Kim Trang BÞ B¶o R­¬ng", tbProp = {6,1,4647,1,0,0}, nRate = 2},		
--		{szName = "Lam Thñy Tinh", tbProp = {4,238,1,1,1,0}, nRate = 10},
--		{szName = "Tinh Hång B¶o Th¹ch", tbProp = {4,353,1,1,1,0}, nRate = 20},
		{szName = "Vinh DiÖu Kim Bµi", tbProp = {6,1,4657,1,0,0}, nRate = 40},
