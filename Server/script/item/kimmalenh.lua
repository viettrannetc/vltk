...
function main(sel)
	dofile("script/item/kimmalenh.lua")
	dialog()
	return 1
end
...
function KML()
	...
	if ( GetTask(T_KML) > 0 ) then
		Say("<color=green>Mçi ngµy chØ cã thÓ sö dông 1 lÇn Kim M· LÖnh",0)
		return
	end
	...
	if (isOK == 0) then
		Msg2Player("Hµnh trang cña "..GetName().." kh«ng mang ®ñ <color=pink>7 Kim M· LÖnh<color> vui lßng kiÓm tra l¹i.")
	elseif (nMoney < MONEY) then
		...
		tl_addPlayerExp(EXP)
		SetTask(T_KML,1)
		Msg2SubWorld("<color=green>"..GetName().." <color=yellow>"..GetName().."<color> thu thËp ®ñ <color=pink>7 Kim M· LÖnh<color> nhËn ®­îc <color=red>3 tû EXP<color>.ThËt kh«ng thÓ tin ®­îc.")
	end
end

function Info()
	local tb_Info = {
			"<color=green>Hoµn Thµnh <color=red>Th¸ch Thøc Thêi Gian<color> sÏ nhËn ®­îc : <color=pink>Kim M· LÖnh - 1<color>.",
			"<color=green>Hoµn Thµnh <color=red>V­ît ¶i Viªm §Õ<color> sÏ nhËn ®­îc : <color=pink>Kim M· LÖnh - 2<color>.",
			"<color=green>Hoµn Thµnh <color=red>Tin Sø<color> sÏ nhËn ®­îc : <color=pink>Kim M· LÖnh - 3<color>.",
			"<color=green>CËp bÕn bê B¾c <color=red>Phong L¨ng §é<color> sÏ nhËn ®­îc : <color=pink>Kim M· LÖnh - 4<color>.",
			"<color=green>Tèng Kim <color=red>500 ®iÓm trë lªn<color> sÏ nhËn ®­îc : <color=pink>Kim M· LÖnh - 5<color>.",
			"<color=green>Hoµn Thµnh <color=red>Khai Ph¸ Vi S¬n §¶o<color> sÏ nhËn ®­îc : <color=pink>Kim M· LÖnh - 6<color>.",
			"<color=green>Hoµn Thµnh 10 nhiÖm vô <color=red>D· TÈu<color> sÏ nhËn ®­îc : <color=pink>Kim M· LÖnh - 7<color>.",
			"<color=yellow>Giao nép <color=pink>7 Kim M· LÖnh<color> vµ 200 v¹n l­îng sÏ nhËn ®­îc <color=red>3 tû EXP<color>.",
		}
