...
TB_XINNIAN_GIFE = {
	...
	[926] = {	{	6,	1,	834,	1,	1,	1	},	"Kim Cang BÊt ph¸ §ång hµnh MËt tÞch cÊp 1 ®Õn cÊp 5, mçi thø mét cuèn",	4,	1,	5},
	[927] = {	{	6,	1,	835,	1,	1,	1	},	"B¸ch §éc BÊt X©m §ång hµnh MËt tÞch cÊp 1 ®Õn cÊp 5, mçi thø mét cuèn",	4,	1,	5},
	[928] = {	{	6,	1,	836,	1,	1,	1	},	"B¨ng TuyÕt S¬ Dung §ång hµnh MËt tÞch cÊp 1 ®Õn cÊp 5, mçi thø mét cuèn",	4,	1,	5},
	[929] = {	{	6,	1,	837,	1,	1,	1	},	"Ch©n Háa Kh¸ng Lùc §ång hµnh MËt tÞch cÊp 1 ®Õn cÊp 5, mçi thø mét cuèn",	4,	1,	5},
	[930] = {	{	6,	1,	838,	1,	1,	1	},	"L«i §×nh Hé gi¸p §ång hµnh MËt tÞch cÊp 1 ®Õn cÊp 5, mçi thø mét cuèn",	4,	1,	5},
