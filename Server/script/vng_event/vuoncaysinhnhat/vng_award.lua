...
function tbSpecialAward:NguyetThan()
	local tbAward = {szName="B¶o r­¬ng may m¾n",tbProp={6,1,4662,1,0,0}, nExpiredTime = 1440, nBindState = -2, nCount=1, tbParam = {1}}
...
function tbSpecialAward:BachKim(nRateIndex)
	...
	local tbAward = {szName="B¶o r­¬ng may m¾n",tbProp={6,1,4662,1,0,0}, nExpiredTime = 1440, nBindState = -2, nCount=1, tbParam = {nRateIndex}}
...
function tbSpecialAward:BatTu()
	local tbAward = {szName="B¶o r­¬ng may m¾n",tbProp={6,1,4662,1,0,0}, nExpiredTime = 1440, nBindState = -2, nCount=1, tbParam = {2}}
...
tbAwardList = {
	[1] = {szName = "§iÓm Kinh NghiÖm", nExp=500000},
	[2] = {szName = "§iÓm Kinh NghiÖm", nExp=1000000},
	[3] = {szName = "§iÓm Kinh NghiÖm", nExp=1500000},
	[4] = {szName = "§iÓm Kinh NghiÖm", nExp=200000},
	[5] = {szName = "§iÓm Kinh NghiÖm", nExp=2500000},
	[6] = {szName = "§iÓm Kinh NghiÖm", nExp=5000000},
