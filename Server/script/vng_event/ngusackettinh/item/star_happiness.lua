...
function main()
	...
	local szFailMsg = format("Mçi ngµy mçi nh©n vËt chØ cã thÓ sö dông nhiÒu nhÊt   %d Ng«i Sao H¹nh Phóc, ®îi ngµy mai h·y sö dông tiÕp",NDAILYTIME)	
