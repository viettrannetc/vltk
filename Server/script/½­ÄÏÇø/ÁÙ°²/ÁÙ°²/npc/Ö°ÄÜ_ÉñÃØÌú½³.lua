...
--ÖØÖı½ğÎÚ×°±¸
Include("\\script\\event\\equip_publish\\tinhsuong\\refine_equip.lua")
Include("\\script\\event\\equip_publish\\wuxingyin\\refine_equip2.lua")
Include("\\script\\event\\equip_publish\\nguyetkhuyet\\refine_equip3.lua")
...
function trungluyentb()
local szTitle = "Xin chµo "..GetName().." ng­¬i muèn trïng luyÖn trang bŞ  nµo."
local tbOpt =
	{
		{"Ta muèn nhê l·o trïng luyÖn trang bŞ §»ng Long",refine_jinwu},
		{"Ta muèn nhê l·o trïng luyÖn trang bŞ Tinh Su¬ng",refine_jinwu2},	
		{"Ta muèn nhê l·o trïng luyÖn trang bŞ NguyÖt KhuyÕt",refine_jinwu3},			
		{"Trë L¹i",main},
		{"Tho¸t"},
	}
